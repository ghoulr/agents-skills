...
by calling the agent CLI (`pi -p --mode text`) as a subprocess.
"""
...
Please respond with only the new description text in <new_description> tags, nothing else."""
    ...
    # Safety net: if the model blew past the 1024-char limit anyway, make one
    # fresh single-turn call that quotes the too-long version and asks for a
    # shorter rewrite.
